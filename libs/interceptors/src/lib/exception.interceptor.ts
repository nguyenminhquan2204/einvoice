import { NestInterceptor, ExecutionContext, CallHandler, Logger, HttpStatus, HttpException } from '@nestjs/common';
  ...
  intercept(context: ExecutionContext, next: CallHandler<any>): Observable<any> | Promise<Observable<any>> {
    ...
    return next.handle().pipe(
      ...
      catchError((error) => {
        ...
        const response = error.getResponse ? error.getResponse() : error.message;
